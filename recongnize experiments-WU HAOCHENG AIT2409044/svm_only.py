...
joblib.dump(pca, os.path.join(output_dir, "SVM_pca.joblib"))'''
# 6. SVM 训练
print("开始训练")
svm = SVC(kernel='rbf', probability=True,class_weight='balanced')
svm.fit(X_train_scaled, y_train)
joblib.dump(svm, os.path.join(output_dir, "svmonly.joblib"))
# 7. 模型评估
...
report_df.to_csv(os.path.join(output_dir, "SVMonly_classification_report.csv"), index=True)
